...
favicon:
  small: /images/favicon/favicon_io/favicon-16x16.png
  medium: /images/favicon/favicon_io/favicon-32x32.png
  apple_touch_icon: /images/favicon/favicon_io/apple-touch-icon.png
...
avatar:
  ...
  # url: /images/avatar/shadow.png
  url: /images/avatar/Picasso_Elephant.png
...
social:
  # GitHub: https://github.com/Saicat || fab fa-github
  E-Mail: mailto:331603034@qq.com || fa-regular fa-envelope
...
utterances:
  enable: true
  repo: Saicat/comment-utterance # Github repository owner and name
...
hide_posts:
  enable: true
  # 可自定义要隐藏的文章的 front-matter 属性
  # 默认为 hidden: true
  filter: hidden
  # 是否将隐藏的文章排除在站点地图之外
  public_generators: []
  # 可选值: 'index', 'tag', 'category', 'archive', 'sitemap', 'feed'
  # 例如: ['sitemap', 'feed'] 会将隐藏的文章排除在站点地图和Feed之外
  # 设为空数组则所有生成器都包含隐藏文章
